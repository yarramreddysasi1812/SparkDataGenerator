...
object DataFrameUtil {
   ...
   */def writeToFileFormats(format: String, dfToWrite: DataFrameWriter[Row]) = {
    format match {
      //case "AVRO" => dfToWrite.format("com.databricks.spark.avro").save(s"C:/Users/TDT/IdeaProjects/SampleData/target/output/test.${format.toString.toLowerCase}")
      case "CSV" => dfToWrite.csv(s"C:/Users/TDT/IdeaProjects/SampleData/target/output/test.${format.toString.toLowerCase}")
      case "JSON" => dfToWrite.json(s"C:/Users/TDT/IdeaProjects/SampleData/target/output/test.${format.toString.toLowerCase}")
     // case "XML" => dfToWrite.format("com.databricks.spark.xml").save(s"C:/Users/TDT/IdeaProjects/SampleData/target/output/test.${format.toString.toLowerCase}")
      case _ | "PARQUET" => dfToWrite.parquet(s"C:/Users/TDT/IdeaProjects/SampleData/target/output/test.${format.toString.toLowerCase}")
    }
  }
